...
1	1	Tokyo (slave2)	2014-04-10 07:24:16	2014-04-10 07:24:16
\.

SELECT pg_catalog.setval('addresses_id_seq', 1, false);

COPY tels (id, user_id, number, created_at, updated_at) FROM stdin;
1	1	03-1111-1111 (slave2)	2014-04-10 07:24:16	2014-04-10 07:24:16
2	1	03-1111-1112 (slave2)	2014-04-10 07:24:16	2014-04-10 07:24:16
3	1	03-1111-1113 (slave2)	2014-04-10 07:24:16	2014-04-10 07:24:16
\.

SELECT pg_catalog.setval('tels_id_seq', 1, false);

COPY users (id, name, created_at, updated_at) FROM stdin;
1	Tsukasa (slave2)	2014-04-10 07:24:16	2014-04-10 07:24:16
